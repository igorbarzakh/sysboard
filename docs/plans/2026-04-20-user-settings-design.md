...
- Avatar upload uses the Neon Object Storage `avatars` bucket through its S3-compatible API.
...
5. Account deletion deletes Neon Storage objects under the user prefix, deletes the user record, and the client signs out.
