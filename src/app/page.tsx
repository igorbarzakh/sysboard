  ...
  return (
    <>
      ...
      <section className={styles.page}>
        ...
        <div aria-hidden="true" className={[styles.glow, styles.glowPrimary].join(" ")} />
        <div aria-hidden="true" className={[styles.glow, styles.glowSecondary].join(" ")} />
        <div aria-hidden="true" className={[styles.glow, styles.glowTertiary].join(" ")} />
